...
The contacts, included in this repo in the root directory, is built with [Assemble](http://assemble.io/) and publicly available at https://owlcarousel2.github.io/OwlCarousel2/. The contacts may also be run locally.
...
The code and the contacts are released under the [MIT License](LICENSE).
